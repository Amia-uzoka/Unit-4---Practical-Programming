...
print("Successfully searched vendors via linear search (on unsorted data)")
...
print("Successfully searched vendors via linear search (on sorted data)")
...
print("Successfully searched vendors via binary search ")
...
print(f"Bubble sort: {time_passed:.6f} seconds")
