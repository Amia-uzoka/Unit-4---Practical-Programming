...
hotdog_data = read_data("Hotdogs (12).txt")
...
def add_vendor(data):
  ...
  #while password != passcode :
    ...
    user_password = int(input("Please enter passcode in order to continue"))
 ...
 #-------------------------------------------------------------------------------
        ...
        while True:
            ...
            vendor_id = input("Enter vendor ID Ensure its in the format XX_YYY  (two letters an underscore followed by 3 numbers ").upper()
            ...
            if len(vendor_id) == 6 :
                ...
                if f_numb_vendor_id.isdigit() and f_alpha_vendor_id.isalpha() and f_u_vendor_id == "_" :
    ...
    #-----------------------------------------------------------------------------
        ...
        while True:
            ...
            #validation ensuring vendor name is the appropriate length and contains no unesscary characters
                
            name_valid = True
            vendor_n = input("Enter vendor name: ")

            try:
                if not vendor_n or not all(c.isalpha() or c.isspace() for c in vendor_n):
                    raise ValueError
        ...
        while True:
            ...
            try:
                ...
                if year > 2026:          
                    ...
                    vendor_date = str(year)+ str(week).zfill(2) #join values of year and week ( zfill() adds zero to the beginning of the string untol it reaches a length of 2 
        ...
        while True:
            try:
                number_of_meat_hotdogs = int(input("Enter number of meatdogs in format "))
                print("Valid Input")
                break
            except ValueError:
    ...
    #----------------------------------------------------------------------------------------
        ...
        user_confirmation = input("Are you sure this is the correct information for your vendor? ")
        if user_confirmation.lower() == "yes" :
            ...
            with open("Hotdogs (12).txt" ,"a")as file: #appends data to text file without overwriting existing file 
